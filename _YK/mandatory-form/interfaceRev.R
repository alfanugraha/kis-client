fieldsMandatory <- c("indName", "orgName", "iiTopicCat", "shapeGeom", "kugiName", "shpData")
                      ...
                      tabPanel("Upload", value="tabUpload", icon = icon("upload"),
                               navlistPanel(widths = c(2, 10),
                                            ...
                                            tabPanel("Upload Data",
                                                     selectInput("shapeGeom", labelMandatory("Tipe data vektor"), choices=c(`Titik`="_PT_", `Garis`="_LN_", `Poligon`="_AR_")),
                                                     uiOutput("listOfKugi"),
                                                     fileInput("shpData", labelMandatory("Upload Shapefile"), buttonLabel="Browse...", placeholder="No file selected", accept = c('zip', 'ZIP', 'ZIP (Archive File)', '.zip', '.ZIP')),
                                                     hr(),
                                            ...
                                            tabPanel(appsMenu$menuItem[2],
                                                     tabBox(width = "200px",
                                                            tabPanel(title = "Identity", 
                                                                     textInput(ctEntity$vars[1], labelMandatory(ctEntity$name[1]), value="", width=NULL, placeholder="Fill the name"),
                                                                     textInput(ctEntity$vars[2], labelMandatory(ctEntity$name[2]), value="", width=NULL, placeholder=""),
                                            ...
                                            # fluidPage(
                                            tabPanel(
                                              actionButton("saveButton", "Simpan"), #, class="btn-primary")
                                              shinyjs::useShinyjs(),
